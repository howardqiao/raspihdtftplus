...
productname="Raspi HD-TFT Plus" # the name of the product to install
...
sudo cp ./requirements/usr/lib/arm-linux-gnueabihf/lxpanel/plugins/batthdtftp.so /usr/lib/arm-linux-gnueabihf/lxpanel/plugins/
